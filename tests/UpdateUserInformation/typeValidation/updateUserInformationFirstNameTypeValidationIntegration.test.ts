...
describe("Wrong first name type for user update", () => {
    ...
    test("Cannot update a user using null as a first name", async () => {
        ...
        expect(response.status).toEqual(422);
        expect(response.body.message).toEqual("First name needs to be of type \"string\", \"null\" given");
        expect(response.body.code).toEqual("first_name_type_is_not_string_but_null");
    });
    ...
    test("Cannot update a user using undefined as a first name", async () => {
        ...
        expect(response.status).toEqual(422);
        expect(response.body.message).toEqual("First name needs to be of type \"string\", \"undefined\" given");
        expect(response.body.code).toEqual("first_name_type_is_not_string_but_undefined");
    });
