...
describe("test user password update feature changed password confirmation type validation", () => {
    test("Cannot update a user's password using an array as a changed password confirmation", async () => {
        ...
        const misformedRequest = () => {
            updateUserPasswordRequest.setChangedPasswordConfirmation(arrayInsteadOfStringInput as unknown as string);
        }

        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"array\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_array");
        }
    });
    ...
    test("Cannot update a user's password using an object as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"object\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_object");
        }
    });
    ...
    test("Cannot update a user's password using null as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"null\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_null");
        }
    });
    ...
    test("Cannot update a user's password using a boolean as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"boolean\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_boolean");
        }
    });
    ...
    test("Cannot update a user's password using undefined as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"undefined\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_undefined");
        }
    });
    ...
    test("Cannot update a user's password using a number as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"number\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_number");
        }
    });
    ...
    test("Cannot update a user's password using a function as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"function\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_function");
        }
    });
    ...
    test("Cannot update a user's password using a symbol as a changed password confirmation", async () => {
        ...
        expect(misformedRequest).toThrow(BadRequestError);
        expect(misformedRequest).toThrow("Changed password confirmation needs to be of type \"string\", \"symbol\" given");

        try {
            await misformedRequest();
        } catch(error: any) {
            expect(error.getErrorCode()).toBe("changed_password_confirmation_type_is_not_string_but_symbol");
        }
    });
});